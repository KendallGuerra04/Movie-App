...
@section('content')
    <div class="container mx-auto max-w-7xl py-2 sm:px-6 lg:px-8 ">
        ...
        <div class="flex items-center justify-center py-4 md:py-8 flex-wrap">
            ...
            <button type="button"
                class="py-3 px-4 mx-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
                Movies
            </button>
            <button type="button"
                class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
